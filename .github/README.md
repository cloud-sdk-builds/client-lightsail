...
[`@aws-sdk/client-lightsail`](https://www.npmjs.com/package/@aws-sdk/client-lightsail/v/3.198.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lightsail@3.198.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SblrLPti7icztyf41rFqhiyqDUYwLO0to80IDoiy6gofoBos1dE3n1k8Y/9AFRmX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-lightsail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lightsail@3.198.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lightsail@3.198.0/index.min.mjs": "sha384-SblrLPti7icztyf41rFqhiyqDUYwLO0to80IDoiy6gofoBos1dE3n1k8Y/9AFRmX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-lightsail/blob/refs/tags/3.198.0/LICENSE
```
