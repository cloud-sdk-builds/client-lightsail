...
[`@aws-sdk/client-lightsail`](https://www.npmjs.com/package/@aws-sdk/client-lightsail/v/3.509.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lightsail@3.509.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8lxLl8KF+QBWnTA06uEH9xivSlapGInYS9ZM2OOU15Sqs5Bx/BhNg/8ThWIumnMv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-lightsail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lightsail@3.509.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lightsail@3.509.0/index.min.mjs": "sha384-8lxLl8KF+QBWnTA06uEH9xivSlapGInYS9ZM2OOU15Sqs5Bx/BhNg/8ThWIumnMv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-lightsail/blob/refs/tags/3.509.0/LICENSE
```
